                           function [figure_handle,count,speeds,directions,Table,Others] = WindRose(direction,speed,estacion,varargin)
...
circlemax               = [];
FreqLabelAngle          = 'auto';
TitleString             = ['Rosa de los vientos aeropuerto Carriel sur en ', estacion];
lablegend               = 'Velocidad del viento [m/s]';
